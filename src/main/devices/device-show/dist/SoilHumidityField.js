...
exports.SoilHumidityField = void 0;
var icons_material_1 = require("@mui/icons-material");
var material_1 = require("@mui/material");
var react_1 = require("react");
var react_admin_1 = require("react-admin");
var ResourceName_1 = require("../../../core/ResourceName");
exports.SoilHumidityField = function (_a) {
    var props = __rest(_a, []);
    var action = props.action, guide = props.guide, rest = __rest(props, ["action", "guide"]);
    var guideMaxSoilHumidity = guide.maxHumidity, guideMinSoilHumidity = guide.minHumidity;
    var deviceSoilHumidity = action.soilHumidity;
    if (guideMaxSoilHumidity < deviceSoilHumidity)
        return (react_1["default"].createElement(react_admin_1.FunctionField, __assign({}, rest, { record: action, resource: ResourceName_1.ResourceName.PLANTS_HIST, source: "airHumidity", render: function (record) { return (react_1["default"].createElement("div", null,
                ...
                record.airHumidity,
                "%`",
                react_1["default"].createElement(material_1.Tooltip, { title: "soil humidity too high" },
    ...
    if (guideMinSoilHumidity > deviceSoilHumidity)
        return (react_1["default"].createElement(react_admin_1.FunctionField, __assign({}, rest, { record: action, resource: ResourceName_1.ResourceName.PLANTS_HIST, source: "airHumidity", render: function (record) { return (react_1["default"].createElement("div", null,
                ...
                record.airHumidity,
                "%`",
                react_1["default"].createElement(material_1.Tooltip, { title: "soil humidity too low" },
                    react_1["default"].createElement(icons_material_1.Feedback, null)))); } })));
    return (react_1["default"].createElement(react_admin_1.FunctionField, __assign({}, rest, { record: action, resource: ResourceName_1.ResourceName.PLANTS_HIST, source: "airHumidity", render: function (record) { return (react_1["default"].createElement("div", null,
            "`$", record === null || record === void 0 ? void 0 :
            record.airHumidity,
